...

{
    ...
    [SerializeField] private float _popUpShowDuration = 6f;
...

    {
        ...
        if (achievement != null && !achievement.IsUnlocked && achievement.Value != "Win")
        {
        ...
        } else if (achievement != null && !achievement.IsUnlocked && achievement.Value == "Win") {
